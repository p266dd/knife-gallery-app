    ...
    <div className="grid grid-cols-4 gap-2">
      ...
      >
        <div>
          <label
            htmlFor="uploadFile"
            className="p-2 mb-2 flex flex-col items-center justify-center w-full border border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50"
          >
          ...
          <label
            htmlFor="captureFile"
            className="sm:hidden p-2 flex flex-col items-center justify-center w-full border border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50"
          >
            <div className="flex flex-col items-center justify-center py-2">
              <motion.p layout className="text-xs text-center text-gray-500">
