      ...
      <AnimatePresence>
        {showPrompt && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="absolute left-1/2 top-5 -translate-x-1/2 w-9/12 py-4 px-8 bg-white shadow-xl rounded-xl border border-slate-200"
          >
            {isIOS ? (
              <>
                ...
                <div className="text-slate-600">
                  <div className="mb-3">
                    ...
                    <br />
                    1. tap the{" "}
                    <span className="underline font-semibold">share button</span>
                ...
                <div className="flex-grow flex flex-col md:flex-row items-center justify-center">
                  ...
                  <div className="flex-grow flex">
                    <button
                      ...
                      className="flex-grow px-4 py-3 text-xs font-semibold rounded-xl"
                    >
                      Don't Show Again
                    </button>
                  </div>
